...
def preprocess_and_get_unique_values(df):
    ...
    unique_values.update({
        'min_month': min_max_values['month']['min'].to_timestamp(),
        'max_month': min_max_values['month']['max'].to_timestamp(),
        'min_hour': min_max_values['hour']['min'],
        'max_hour': min_max_values['hour']['max']
    })
